...
const About = () => {
  return (
    ...
    <div className="bg-zinc-900">
      ...
      <div className="text-center text-3xl font-bold text-white mt-4">Testimonial</div>
      <div className=" flex-col container md:grid md:grid-cols-3  lg: grid lg:grid-cols-4  p-2 md:p-8 ">
