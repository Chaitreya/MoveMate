...
function Home(){
    return(
        <div className='flex justify-center items-start bg-zinc-900 '>
            <div className="flex flex-col justify-center mt-36 mx-8">
                <div className="text-white  p-2 flex flex-col h-2/3 border-b pb-24">
                    ...
                    <div className="flex justify-end">
                        <Link to={'/register'} className="mt-20 px-4 py-3 text-lg font-semibold cursor-pointer bg-rose-500 hover:bg-rose-700 duration-200 rounded-lg justify-self-end w-1/2 text-center">Sign Up Now</Link>
                    </div>
                </div>
